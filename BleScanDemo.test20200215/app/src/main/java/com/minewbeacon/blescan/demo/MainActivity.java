        ...
        mMinewBeaconManager.setDeviceManagerDelegateListener(new MinewBeaconManagerListener() {
            ...
            public void onRangeBeacons(final List<MinewBeacon> minewBeacons) {
                ...
                if(!minewBeacons.isEmpty()){
                    //Log.e("tag", state + minewBeacons.get(0).getBeaconValue(BeaconValueIndex.MinewBeaconValueIndex_Name).getStringValue());

                    if(minewBeacons.get(0).getBeaconValue(BeaconValueIndex.MinewBeaconValueIndex_Name).getStringValue().equals("beacon2")){
                        Toast.makeText(getApplicationContext(), "beacon1인식", Toast.LENGTH_SHORT).show();
                        Log.e("tag", state + "beacon1");
                    }else if(minewBeacons.get(0).getBeaconValue(BeaconValueIndex.MinewBeaconValueIndex_Name).getStringValue().equals("beacon1")){
                        Toast.makeText(getApplicationContext(), "beacon2인식", Toast.LENGTH_SHORT).show();
                        Log.e("tag", state + "beacon2");
                    }
                }
